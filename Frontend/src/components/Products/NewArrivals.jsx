...
import { newArrivalsProducts } from "../../redux/slices/product.slice.js";
...
const NewArrivals = () => {
  ...
  //const{newArrivals,loading,error}=useSelector((state)=>state.product)
  useEffect(() => {
    ...
    newArrivalsProducts();
    //setNewArrival(newArrivalsProducts())
