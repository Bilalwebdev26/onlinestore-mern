    ...
    <section className='py-16 px-4 '>
      <div className="conatiner mx-auto flex flex-col md:flex-row  gap-8">
       ...
       <div className="relative flex-1">
        <img src={WomensCollection} alt="Womens Collection" className='w-full h-[450px] sm:h-[500px] object-cover rounded-lg' />
       ...
       <div className="relative flex-1">
        <img src={MenCollection} alt="Womens Collection" className='w-full h-[450px] sm:h-[500px] object-cover rounded-lg' />
        <div className="absolute bg-white bottom-8 left-8 sm:left-2 opacity-90 p-4 ">
            <h2 className='text-xl sm:text-2xl font-bold text-gray-900 mb-3'>
                Men's Collection
            </h2>
